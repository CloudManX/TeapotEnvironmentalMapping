//-------------------------------------------------------------------------
function terrainFromIteration(n, minX,maxX,minY,maxY, vertexArray, faceArray,normalArray, texCoordArray)
{
    ...
    for(var i=0;i<=n;i++)
       for(var j=0;j<=n;j++)
       {
           ...
           texCoordArray.push((minX+deltaX*j)/8 + 0.5)
           texCoordArray.push((minY+deltaY*i)/8 + 0.5)
